      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-6">
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow-2xl p-8 md:p-12 animate-fade-in">
          ...
          <div className="space-y-6 mb-10">
            <div className="flex items-start gap-4 p-4 rounded-lg bg-blue-50 hover:bg-blue-100 transition">
            ...
            <div className="flex items-start gap-4 p-4 rounded-lg bg-green-50 hover:bg-green-100 transition">
            ...
            <div className="flex items-start gap-4 p-4 rounded-lg bg-orange-50 hover:bg-orange-100 transition">
