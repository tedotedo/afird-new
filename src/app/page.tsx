      ...
      <section className="border-b border-rule bg-paper-card">
        <div className="mx-auto max-w-site px-4 py-14 sm:px-6 sm:py-20">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-ink-muted">
            Your child eats from a short list of foods. Mealtimes are a struggle, or your child barely seems interested in food at all. You might worry about growth, or whether this is sensory and possibly autism-related. That is what this site is for.
          </p>
