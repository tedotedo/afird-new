    ...
    <AuthGuard>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 pb-24">
        ...
        <div className="container mx-auto px-4 max-w-4xl mt-8 space-y-8">
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-xl shadow-lg p-8">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-xl font-bold text-yellow-900 mb-3">Important Medical Disclaimer</h3>
                <div className="space-y-3 text-sm text-yellow-800 leading-relaxed">
                  <p>
                    <strong>This application is a nutritional tracking tool only.</strong> All nutritional analyses provided are estimates 
                    based on AI image recognition and food label databases. The accuracy of these estimates can vary considerably due to 
                    factors including food preparation methods, portion sizes, ingredient variations, and image quality.
                  </p>
                  <p>
                    <strong>This tool does not provide medical advice.</strong> The information provided through this app is for general 
                    tracking and informational purposes only and should never be used as a substitute for professional medical, dietary, 
                    or nutritional advice, diagnosis, or treatment.
                  </p>
                  <p>
                    <strong>Always seek professional medical guidance.</strong> You should always consult with a qualified healthcare 
                    professional, registered dietitian, or physician regarding any health conditions, dietary requirements, nutritional 
                    concerns, or before making any changes to your diet or your child's diet. This is particularly crucial for individuals 
                    managing ARFID (Avoidant/Restrictive Food Intake Disorder) or other eating disorders, food allergies, medical conditions, 
                    or special dietary needs.
                  </p>
                  <p>
                    <strong>No physician-patient relationship.</strong> Use of this application does not create a physician-patient 
                    relationship. If you have any medical concerns or questions, please contact your healthcare provider immediately.
                  </p>
                </div>
              </div>
            </div>
