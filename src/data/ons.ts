...
export const onsProducts: OnsProduct[] = [
  ...
  },
  {
    ...
    brand: 'Nutricia Fortini',
    form: 'liquid-sip',
    formLabel: 'Compact ready-to-drink ONS (125 ml)',
    ...
    keyContents:
      'About 2.4 kcal/ml (~300 kcal and ~7.2 g protein per 125 ml on Nutricia range materials); fibre-containing complete paediatric ONS',
  ...
  },
  {
    ...
    brand: 'Abbott',
    form: 'liquid-sip',
    formLabel: 'Ready-to-drink milkshake-style ONS (200 ml)',
  ...
  {
    id: 'paediasure-plus',
    name: 'PaediaSure Plus (ONS bottle)',
    brand: 'Abbott',
    form: 'liquid-sip',
    formLabel: 'Higher-energy milkshake-style ONS (200 ml)',
    ...
    keyContents: 'About 1.5 kcal/ml (~302 kcal and 8.4 g protein per 200 ml ONS); vitamins and minerals',
  ...
  },
  {
    ...
    brand: 'Abbott',
    form: 'liquid-sip',
    formLabel: 'Compact high-energy milkshake-style ONS',
    ...
    keyContents: 'About 2.4 kcal/ml ready-to-drink paediatric ONS with vitamins and minerals (confirm pack)',
    ...
    infoLabel: 'Abbott — children’s ONS overview (includes Compact)',
  },
  {
    ...
    brand: 'Abbott',
    form: 'smoothie',
    formLabel: 'Juice-style ready-to-drink ONS',
    ...
    keyContents: 'About 1.5 kcal/ml juice-style paediatric ONS with vitamins and minerals',
    ...
    infoUrl: 'https://www.proconnect.abbott/uk/en/patient-carers/products-landing-page/paediatric-products-lp/children-s-oral-nutritional-supplements.html',
    infoLabel: 'Abbott — children’s ONS overview (includes Plus Juce)',
  },
  {
  ...
  },
  {
    ...
    notes: 'FSMP. Often described as the paediatric yoghurt-style ONS option in UK dietetic practice.',
  ...
  },
  {
    ...
    notes:
      'ACBS-prescribable borderline substance in UK practice for indicated fortification. Easy to over- or under-dose without dietetic instruction — not a DIY calorie hack.',
